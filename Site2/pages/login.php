...
<main class="form-signin w-100 m-auto">
    <form action="index.php?page=login" method="post">
        ...
        <div class="mb-2">
            ...
            <a href="index.php?page=register" class="btn btn-secondary w-100 py-2 mt-2">Register</a>
        </div>
    </form>
</main>
<style>
...
if (isset($_POST['loginButton'])) {
    if (isset($_POST['rememberMe'])) {
        login($_POST['username'], $_POST['password'], $_POST['rememberMe'], 'index.php?page=index');
    } else {
        login($_POST['username'], $_POST['password'], urlToRedirect: 'index.php');
    }
}
?>